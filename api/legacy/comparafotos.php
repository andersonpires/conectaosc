...
include dirname(__DIR__) . '/conectabd/conexao.php';
...
// Diretorios
$pastaDestino = dirname(__DIR__, 2) . '/app/assets/img/fotos/';
...
// Verifica quais arquivos estao no banco, mas nao na pasta
...
if (empty($fotosRestantes)) {
    ...
    echo "Os seguintes arquivos ainda estao faltando:";
