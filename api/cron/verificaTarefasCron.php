...
$runtime = require $projectRoot . '/bootstrap/runtime.php';
$BASE_para_PATH = $runtime['base_para_path'];
$BASE_para_URL = $runtime['base_para_url'];

require_once $projectRoot . '/api/repositories/CrmRepository.php';
require_once $projectRoot . '/api/services/CrmService.php';
require_once $projectRoot . '/app/views/crm/notificarUsuario.php';
