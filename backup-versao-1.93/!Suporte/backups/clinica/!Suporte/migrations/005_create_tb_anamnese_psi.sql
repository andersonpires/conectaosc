-- Migration 005: Tabela tb_anamnese_psi - Anamnese psicológica
...
CREATE TABLE IF NOT EXISTS tb_anamnese_psi (
    ...
    -- 6 - FUNCIONALIDADE COGNITIVA (Respondeu adequadamente / Não respondeu adequadamente)
    ...
    -- 9 - MEMÓRIA, COTIDIANO E EXPECTATIVAS
    ...
    -- 10 - OBSERVAÇÕES E IMPRESSÕES GERAIS
