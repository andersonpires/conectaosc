...
// Garantir BASE_PATH quando acessado via API (session do login principal)
...
$basePath = (strpos($reqUri, '/conectaosc/clinica/api') !== false) ? '/conectaosc/clinica/api' : '/clinica/api';
