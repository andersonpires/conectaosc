...
try {
	...
	// Preenche o array $data com os totais de aulas, ajustando o índice (mês - 1)
						...
						<div class="col-sm-6">
							<div class="card">
								<div class="card-body">
									<div class="row">
										<div class="col mt-0">
											<h5 class="card-title">Matrículas ativas / Total matriculados</h5>
										</div>
										<div class="col-auto">
											<div class="stat text-primary">
			...
			<div class="col-12 col-md-12 col-xxl-6 d-flex order-3 order-xxl-2">
				<div class="card flex-fill w-100">
					<div class="card-header">
						...
						<h5 class="card-title mb-0">Qtd Matrículas últimos 12 meses - <?php echo $total_Matricula ?> no total</h5>
					</div>
					...
					<table class="table table-hover my-0">
						...
						<tbody>
							<?php //foreach ($matriculas as $linha): ?>
								<tr>
									<td><img src="<?php //echo $_SESSION['BASE_URL']; ?>/assets/img/fotos/<?php //echo $linha['Foto']; ?>" id="fotoMatriculado" class="rounded-circle img-cover fotografia" width="30px" height="30px"></td>
