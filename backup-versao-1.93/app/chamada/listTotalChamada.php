...
<head>
    ...
    <script>
        toastr.options = {
            ...
            "newestOnTop": true,
            "progressBar": true,
            "positionClass": "toast-top-center", // pode ser top-right, top-left, bottom-center etc
...
<body>
    ...
    <script>
        const DADOS_GLOBAIS = {
            ...
            idMatricula: <?php echo json_encode($idMatricula); ?> // <-- AQUI, adicionar isso!
        };
    </script>
    ...
    <script>
        ...
        $(document).ready(function() {
            ...
            $.ajax({
                url: '<?php echo $_SESSION['BASE_URL']; ?>/app/feriados/feriadosController.php',
                method: 'POST',
                dataType: 'json',
                data: {
                    acao: 'verificar',
