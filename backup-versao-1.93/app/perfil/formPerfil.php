                        ...
                        <div class="col-md-4 col-xl-3">
                            <div class="card mb-3">
                                ...
                                <div class="card-body text-center">
                                    <img src="<?php echo $_SESSION['BASE_URL']; ?>/assets/img/fotos/<?php echo $colaborador['Foto']; ?>" alt="<?php echo $NomeColaborador; ?>" class="rounded-circle img-cover mb-2" width="128" height="128" />
                                ...
                                <hr class="my-0" />
                                <div class="card-body">
                                    <h5 class="h6 card-title">Competências</h5>
                                    <a href="#" class="badge bg-primary me-1 my-1">Projetos</a>
                                    <a href="#" class="badge bg-primary me-1 my-1">Comunicação</a>
                                    <a href="#" class="badge bg-primary me-1 my-1">Eventos</a>
                                    <a href="#" class="badge bg-primary me-1 my-1">Atendimento ao público</a>
                                    <a href="#" class="badge bg-primary me-1 my-1">Cadastro</a>
                                    <a href="#" class="badge bg-primary me-1 my-1">Gestão</a>
                                </div>
                                <hr class="my-0" />
                                <div class="card-body">
                                ...
                                <div class="card-body h-100">
                                    <div class="col-12">
                                        <div class="col-12">
                                            <div class="card">
                                                <div class="card-body">
                                                    <form action="perfilController.php" enctype='multipart/form-data' method='post' onsubmit="return avisoSalvarPerfil();">
...
<script>
    function avisoSalvarPerfil() {
        if (typeof mostrarOverlay === 'function') {
            mostrarOverlay({
                mensagem: 'Após salvar as alterações, você precisará logar-se novamente!',
                carregando: true
            });
        }
        return true;
