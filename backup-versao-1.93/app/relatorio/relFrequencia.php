...
<head>
    ...
    <style>
        ...
        table {
            ...
            /* Impede quebra forçada */
            white-space: nowrap;
            /* Mantém as colunas lado a lado */
        }
    </style>
</head>
...
<body>
    <div class="wrapper">
        ...
        <div class="main">
            ...
            $stmt = $pdo->query("SELECT DISTINCT IdCurso, NomeCurso FROM tbCurso WHERE Habilitado = 1 ORDER BY NomeCurso");
            ...
            <script>
                ...
                $('#gerarRelatorio').click(function(e) {
                    ...
                    let getFrequencia1 = "<?php echo $_SESSION['BASE_URL'] ?>/get/getFrequencia.php";
                    $.post(getFrequencia1, {
                        curso,
                        turma,
                        mesAno,
            ...
            <script>
                ...
                $('#gerarRelatorioInterval').click(function(e) {
                    ...
                    let getFrequencia = "<?php echo $_SESSION['BASE_URL'] ?>/get/getFrequenciaInterval.php";
                    ...
                    $.post(getFrequencia, {
                        ...
                        // Criar conjunto de dias únicos (formatados como 'dd/mm/yy') e ordenados
            ...
            <p style="margin-top: 10px; font-style: italic;">
                ...
                $('#salvarPDF2').click(function(e) {
                    ...
                    let getPDFInterval = "<?php echo $_SESSION['BASE_URL'] ?>/get/";
...
<script>
    function recarregarCursos() {
        ...
        const getCursos = "<?php echo $_SESSION['BASE_URL'] ?>/get/getCursos.php";
...
<script>
    ...
    $('#salvarExcel').click(function(e) {
        ...
        let getExcelURL = "<?php echo $_SESSION['BASE_URL'] ?>/get/getEXCEL.php";
    ...
    $('#salvarExcel2').click(function(e) {
        ...
        let getExcelIntervalURL = "<?php echo $_SESSION['BASE_URL'] ?>/get/getEXCELInterval.php?format=json";
