...
<body>
                                ...
                                <div class="mb-3">
                                    ...
                                    <div class="dropdown">
                                        ...
                                        <div class="dropdown-menu p-3" aria-labelledby="dropdownInteresses" style="max-height: 320px; overflow-y: auto;">
                                            <?php
                                            $stmtProjetos = $pdo->query("SELECT IdProjeto, NomeProjeto FROM tbProjeto ORDER BY NomeProjeto ASC");
                                            foreach ($stmtProjetos->fetchAll() as $projeto) {
                                                $idProjeto = htmlspecialchars($projeto['IdProjeto']);
    ...
    function recarregarCursos() {
        ...
        $.post('<?php echo $_SESSION['BASE_URL']; ?>/get/getCursosTodos.php', {
    ...
    $('#salvarPdf').click(function() {
        ...
        const url = '<?php echo $_SESSION['BASE_URL']; ?>/get/getCustomAlunoPDF.php?' + params.toString();
