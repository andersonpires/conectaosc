...
// Ordenar os grupos por TipoApp, exceto o grupo "Outros" que ficará por último
ksort($grupos);
...
<head>
    ...
    <style>
        ...
        .list-group {
            flex: 1 1 200px;
            /* Garante que ocupe no mínimo 200px e se expanda até o limite */
        }
                        ...
                        <div class="card-body">
                            <form id="formPermissao" method="post">
                                ...
                                <div class="mb-3">
                                    ...
                                    <!-- List Group com as páginas agrupadas -->
                                ...
                                <div class="d-flex gap-2">
                                    ...
                                    <a href="permissaoController.php?view=list" class="btn btn-secondary">Retornar</a>
                                </div>
...
<script>
    $(document).ready(function() {
        ...
        $('#formPermissao').on('submit', function(e) {
            ...
            $.post('listPermissaoController.php', formData, function(res) {
                if (res.status === 'ok') {
                    mostrarOverlay({
                        mensagem: res.msg,
                        carregando: false,
                        onClose: () => window.location.href = 'permissaoController.php?view=list'
                    });
                } else {
                    mostrarOverlay({
    ...
    $(function() {
        ...
        // Se o campo está desmarcado (por reedição), mostramos a grade
