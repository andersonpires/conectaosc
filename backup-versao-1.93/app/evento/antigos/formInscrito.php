<!-- SERVIÇO DE INSCRIÇÃO EVENTO 3O SETOR - FORM PARA INSCRIÇÃO -->
                    ...
                    <div class="container mt-5">
                        ...
                        <form id="formulario" action="cadInscrito.php" method="POST">
                            ...
                            <div class="card shadow-lg">
                                <div class="card-body">
                                    <!-- Nome Completo -->
                                    <span style="font-style: italic;">Os itens com asterico (*) são de preenchimento obrigatório.</span>
                                    <p></p>
                                    <div class="mb-3">
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            async function validateFields() {
                ...
                const telefoneSomenteNumeros = telefoneField.value.replace(/\D/g, ""); // Remove tudo que não é número
