        ...
        <div class="main">
            ...
            <main class="content">
                <div class="container-fluid p-0">
                    ...
                    if (!$cpfInformado) {
                    ?>
                        <form method="GET" action="beneficiarioController.php">
...
<form action="beneficiarioController.php" id="formulario" enctype="multipart/form-data" method="post">
            ...
            <div class="card-body">
                <div class="d-flex justify-content-end mb-3">
                    <?php if (!empty($_POST['IdUsuario'])): ?>
                        <a class="btn btn-success" target="_blank" href="<?= $_SESSION['BASE_URL'] ?>/get/getPDF_ficha_cadastro.php?id=<?= $_POST['IdUsuario'] ?>">
                ...
                <div class="mb-3">
                    ...
                    $caminhoFoto = $_SESSION['BASE_URL'] . "/assets/img/fotos/" . $fotoAtual;
                    ?>
                    <br>
                    <img src="<?= htmlspecialchars($caminhoFoto) ?>" class="rounded-circle img-cover" width="100px" height="100px" id="currentPhoto">
                    <br>
                    <label for="uploadImage" class="form-label">Foto beneficiário</label>
                ...
                ?>
                    ...
                    <div class="text-center mb3">
                        <p class="text-center">SE É INSCRIÇÃO, SELECIONE OS INTERESSES:</p>
                    </div>
    ...
    <div class="col-11">
        <div class="card shadow-lg">
            <div class="card-body">
                ...
                <div class="row mb-3">
                    <div class="col-md-4">
                        <label class="form-label">Nº de pessoas na residência</label>
                    ...
                    <div class="col-md-4">
                        ...
                        <select name="ComQuemMora" class="form-select">
                            <option value="">Selecione</option>
                            <?php
                            $opcoes = ["Sozinho", "Família nuclear", "Parentes", "Outros"];
                ...
                <div class="row mb-3">
                    ...
                    <!-- Quantos e quais deficiências -->
                    <div class="col-md-5">
                        <label class="form-label">Quantos e quais deficiências</label>
                        <input type="text"
                ...
                <div class="row mb-3">
                    ...
                    <div class="col-md-4">
                        ...
                        <select name="AbastecimentoAgua" class="form-select">
                            <option value="">Selecione</option>
                            <?php
                            $opcoes = ["Rede pública", "Poço", "Outro"];
                ...
                <div class="row mb-3">
                    <div class="col-md-4">
                        ...
                        <select name="EsgotamentoSanitario" class="form-select">
                            <option value="">Selecione</option>
                            <?php
                            $opcoes = ["Rede pública", "Fossa séptica", "Céu aberto"];
...
<script type="text/javascript">
    $(document).ready(function() {
        ...
        // Dispara o cálculo sempre que mudar RendaFamiliar ou NumPessoasReside
...
<script>
    (function() {
        ...
        function garantirAcaoNoPost(valor) {
            // garante que acao vá no POST mesmo com submit programático
        ...
        form.addEventListener('submit', function handler(e) {
            const btn = e.submitter; // botão clicado (quando existe)
            ...
            if (acao === 'avaliar_vulnerabilidade') {
                ...
                fetch('avaliarVulnerabilidadeStream.php', {
                    method: 'POST',
                    body: formData,
                    ...
                    const processarChunk = ({ value, done }) => {
                        ...
                        partes.forEach(parte => {
                            ...
                            if (evento === 'delta') {
                                ...
                                // Ignorado: os status são controlados no cliente
