...
<body>
                    ...
                    <div class="row">
                        <div class="col-md-4 col-xl-3">
                            <div class="card mb-3">
                                    ...
                                    <ul class="list-unstyled mb-0">
                                        ...
                                        ?>
                                            <li class="mb-1 hover-container"> <span>
                                                    <img src="<?php echo $_SESSION['BASE_URL']; ?>/assets/img/fotos/<?php echo $Foto ?>" class="rounded-circle img-cover hover-img" width='20px' height='20px'>
                                ...
                                <div class="card-body">
                                    <h5 class="h6 card-title">Total de pessoas à matricular</h5>
                                    <ul class="list-unstyled mb-0">
                                        ...
                                        <div class="row mb-3 curso-turma-item">
                                            <div class="form-group col-12 col-md-5">
                                                ...
                                                <select class="form-select js-select-curso" aria-label="Selecione o curso" name="NNomeCurso">
                                                    ...
                                                    <?php
                                                    $sql = "SELECT * FROM tbCurso WHERE Habilitado = 1";
                                                    $busca2 = $pdo->query($sql);
                                                    while ($dados = $busca2->fetch(PDO::FETCH_ASSOC)) {
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            const turmasUrl = "<?php echo $_SESSION['BASE_URL'] . '/get/getTurmas.php' ?>";
            ...
            function carregarTurmas(selectCurso, selectTurma) {
                ...
                const bodyData = `IdCurso=${encodeURIComponent(cursoId)}&todasTurmas=0`;
    ...
    <script>
        document.getElementById("SalvarMatriculas").addEventListener("click", function() {
            ...
            if (erroSelect > 0 && erroQuant > 0) {
                alert("Você precisa escolher quais cursos à matricular e inserir a turma!");
            } else if (erroSelect > 0 && erroQuant == 0) {
                alert("Você precisa escolher cursos à matricular!");
            } else if (erroSelect == 0 && erroQuant > 0) {
