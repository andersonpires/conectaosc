...
if (!$lista) {
    die("<div class='alert alert-danger'>Nenhum aluno ativo encontrado neste curso.</div>");
}
...
$nomeCurso = $lista[0]['NomeCurso'] ?? '';
$nomeDocumento = trim($nomeCurso) !== '' ? ("Contratos - " . $nomeCurso) : "Contratos";
...
$pdf->Output("contratos_curso_" . $idCurso . ".pdf", 'I');
exit;
