        ...
        <div class="main">
            ...
            <main class="content">
                <div class="container-fluid p-0">
                    ...
                    <!-- Conteúdo da página: Listagem de alunos e cursos -->
                    <div class="col-12">
                        <h4 class="h3 mb-3" id="titulo">Total de matrículas</h4>
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex flex-wrap justify-content-between align-items-center gap-2 mb-3">
                                    <a href="<?php echo $_SESSION['BASE_URL']; ?>/app/beneficiario/listagemSBenef.php" class="btn btn-primary" id="novoAluno">Matricular novo aluno</a>
                                ...
                                <div class="table-responsive">
                                    <table id="minhaTabela" class="table table-striped table-hover">
                                        ...
                                        <tbody>
                                            <?php
                                            // Configurar group_concat_max_len para garantir concatenação completa
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo "<a href='listTurmasMat.php?turma=$IdTurma'>$nomeTurma</a>" ?></td>
                                                    ...
                                                    <td>
                                                        <a class="btn btn-info btn-sm" href="gerarContratosCurso.php?curso=<?php echo $dados['IdCurso']; ?>" title="Gerar contratos do curso" target="_blank">
