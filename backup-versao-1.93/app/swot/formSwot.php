                ...
                <div class="container-fluid p-0">
                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            ...
                            <form action="swotController.php" method="post">
        ...
        $textoJson = htmlspecialchars(json_encode(html_entity_decode((string) ($item['Texto'] ?? ''), ENT_QUOTES | ENT_HTML5, 'UTF-8'), JSON_UNESCAPED_UNICODE), ENT_QUOTES, 'UTF-8');
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        ...
                                                        <form action="swotController.php" method="post" style="display:inline-block;" onsubmit="return confirm('Excluir este insight?');">
