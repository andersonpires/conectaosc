...
<body>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="form-check">
                                            ...
                                            <label class="form-check-label" for="nota_email">
                                                E-mail: <span id="emailUsuario"></span> <a href="<?php echo $_SESSION['BASE_URL']; ?>/app/perfil/perfilController.php?m=mail">(mudar)</a>
                                            </label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="nota_whatsapp" <?= $desabilita ?>>
                                            <label class="form-check-label" for="nota_whatsapp">
                                                WhatsApp: <span id="zapUsuario"></span> <a href="<?php echo $_SESSION['BASE_URL']; ?>/app/perfil/perfilController.php?m=ws" <?php echo ($ativaZap == false) ? 'disabled' : ''; ?>>(mudar)</a>
                                            </label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="form-check">
                                            ...
                                            <label class="form-check-label" for="tarefa_email">
                                                E-mail: <span id="emailUsuario2"></span> <a href="<?php echo $_SESSION['BASE_URL']; ?>/app/perfil/perfilController.php?m=mail">(mudar)</a>
                                            </label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="tarefa_whatsapp" <?= $desabilita ?>>
                                            <label class="form-check-label" for="tarefa_whatsapp">
                                                WhatsApp: <span id="zapUsuario2"></span> <a href="<?php echo $_SESSION['BASE_URL']; ?>/app/perfil/perfilController.php?m=ws" <?php echo ($ativaZap == false) ? 'disabled' : ''; ?>>(mudar)</a>
                                            </label>
                                        </div>
                                    </div>
                    ...
                    if (data.status === 'ok') {
                        ...
                        fichaDiv.innerHTML = `
                                                <div class="d-flex align-items-center mb-3">
                                                    ...
                                                    <div>
                                                        <h5 class="mb-0">
                                                            <a href="<?php echo $_SESSION['BASE_URL']; ?>/app/chamada/listTotalChamada.php?idAluno=${idUsuario}&NNomeCurso=${a.IdCurso}&NNomeTurma=${a.IdTurma}" target="_blank" class="text-decoration-none">
    ...
    <script>
        ...
        function salvarPreferencias(mostrarMensagem = false) {
            ...
            if (mostrarMensagem) {
                msgEl.innerHTML = `<div class="spinner-border spinner-border-sm text-primary me-2" role="status"></div> Salvando preferências...`;
            }
    ...
    <script>
        ...
        document.getElementById('menuVerMatricula').addEventListener('click', function() {
            const url = '<?php echo $_SESSION['BASE_URL']; ?>/app/matricula/listTurmasMat.php?turma=' + alunoSelecionadoMenu.IdTurma;
            window.open(url, '_blank');
        });

        document.getElementById('menuListarFaltas').addEventListener('click', function() {
            const url = '<?php echo $_SESSION['BASE_URL']; ?>/app/chamada/listTotalChamada.php?idAluno=' + alunoSelecionadoMenu.IdUsuario + '&NNomeCurso=' + alunoSelecionadoMenu.IdCurso + '&NNomeTurma=' + alunoSelecionadoMenu.IdTurma;
            window.open(url, '_blank');
        });

        document.getElementById('menuDadosAluno').addEventListener('click', function() {
            abrirPostNovaAba('<?php echo $_SESSION['BASE_URL']; ?>/app/beneficiario/formEditarBenef.php', {
                IdUsuario: alunoSelecionadoMenu.IdUsuario
            });
        });

        // Função para abrir via POST
