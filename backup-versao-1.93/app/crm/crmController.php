...
switch ($action) {
    ...
    case 'buscarAlunosFaltosos':
        ...
        $somenteMatriculados = $_POST['somenteMatriculados'] ?? 1;
        ...
        $sql = "SELECT a.IdUsuario, a.Nome, a.Apelido, a.Foto, a.Telefone, a.WhatsApp, a.Endereco, a.Bairro, a.Cidade, a.UF,
               cu.NomeCurso, cu.IdCurso, t.IdTurma, t.NomeTurma, m.Habilitado,
        ...
        LEFT JOIN tbMatricula m ON m.IdUsuario = a.IdUsuario 
    ...
    case 'dadosAluno':
        ...
        $sql = "SELECT a.Foto, a.Nome, a.Apelido, a.Telefone, a.WhatsApp, a.Endereco, a.Bairro, a.Cidade, a.UF,
                           cu.NomeCurso, cu.IdCurso, t.NomeTurma, t.IdTurma,
