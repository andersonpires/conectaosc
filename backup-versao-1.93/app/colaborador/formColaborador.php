                ...
                <div class="container-fluid p-0">
                    ...
                    ?>
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <form action="colaboradorController.php" enctype="multipart/form-data" method="post" onsubmit="mostrarOverlay({ mensagem: 'Alterando dados...', carregando: true })">
...
<?php if (false): ?>
                                        <div class="mb-3">
                                            <label for="especialidade_id" class="form-label">Especialidade (App Clínica)</label>
                    ...
                    <?php } else { ?>
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <form action="colaboradorController.php" enctype="multipart/form-data" method="post" onsubmit="mostrarOverlay({ mensagem: 'Salvando dados...', carregando: true })">
                                        <div class="row mb-3">
                                            <div class="col-5">
                                                <label for="Nome" class="form-label">Nome</label>
                    ...
                    <div class="card">
                        <div class="card-header d-flex flex-wrap align-items-center gap-2">
                            ...
                            <div class="btn-group ms-auto" role="group" aria-label="Filtro de status">
                                <a href="colaboradorController.php?status=ativos" class="btn btn-sm <?php echo ($statusFiltro ?? 'ativos') === 'ativos' ? 'btn-primary' : 'btn-outline-primary'; ?>">Ativos</a>
                                <a href="colaboradorController.php?status=inativos" class="btn btn-sm <?php echo ($statusFiltro ?? 'ativos') === 'inativos' ? 'btn-primary' : 'btn-outline-primary'; ?>">Inativos</a>
                            </div>
                        </div>
                        <div class="card-body">
                                ...
                                <table id="minhaTabela" class="table table-striped table-hover datatable-custom table-layout-auto">
                                    ...
                                    <tbody>
                                            ...
                                            <?php foreach ($listaColaboradores as $dados): ?>
                                                ...
                                                <tr>
                                                    <td>
                                                        <img src="<?php echo $_SESSION['BASE_URL']; ?>/assets/img/fotos/<?php echo htmlspecialchars($Foto); ?>" class="rounded-circle img-cover" width="40px" height="40px">
                                                    </td>
                                                    ...
                                                    <td>
                                                        ...
                                                        <?php else: ?>
                                                            <form action="colaboradorController.php" method="post" style="display:inline-block;">
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <form action="colaboradorController.php" method="post" onsubmit="mostrarOverlay({ mensagem: 'Inativando usuario...', carregando: true })">
...
<script>
    function alterarColaborador(id) {
        ...
        form.method = 'POST';
        form.action = 'colaboradorController.php';
...
</script>SESSION['BASE_PATH'] . '/checa-token.php';
?>
