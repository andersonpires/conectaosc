...
<div class="card mb-4">
    <div class="card-body d-flex align-items-center">
        <img src="<?php echo htmlspecialchars(bootstrap_foto_url((string)($aluno['Foto'] ?? '')), ENT_QUOTES, 'UTF-8'); ?>" class="rounded-circle me-3" width="80" height="80">
        <div>
    ...
    <div class="card-body table-responsive">
        <div class="row mb-3">
            <div class="col">
                ...
                <p id="resumo-frequencia-aluno" class="mt-2 mb-0 text-muted"></p>
            </div>
            <div class="col">
                <?php $diasSemana = ['Segunda', 'Terça', 'Quarta', 'Quinta', 'Sexta', 'Sabado', 'Domingo'];
        ...
        <table class="table table-hover" id="tabelaPresencas">
            ...
            <tbody>
                <?php $sqlChamadasPeriodo = $pdo->prepare("
