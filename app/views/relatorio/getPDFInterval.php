...
$pathOriginais = $pathStorageBase . 'originais/';
...
$previewAction = rtrim((string)$BASE_para_URL, '/') . '/assinatura/pdf/preview/';
header('Content-Type: text/html; charset=utf-8');
echo '<form id="goPreviewRelatorio" method="POST" action="' . htmlspecialchars($previewAction, ENT_QUOTES, 'UTF-8') . '">';
echo '<input type="hidden" name="file" value="' . htmlspecialchars($nomeArquivoPreview, ENT_QUOTES, 'UTF-8') . '">';
