...
<head>
    ...
    <script>
        tinymce.init({
            ...
            images_upload_handler: (blobInfo, progress) => new Promise((resolve, reject) => {
                ...
                xhr.open('POST', '<?php echo rtrim((string)$BASE_para_URL, '/'); ?>/atendimento/salvar/');
    ...
    <script>
        function mostrarDiv(area) {
            // Lista das divs que queremos alternar a visibilidade
...
<body>
        ...
        <div class="main">
            ...
            <main class="content">
                <div class="container-fluid mt-4">
                    ...
                    <!-- Área de Timeline (Notas e Histórico de Interações) -->
    ...
    <script>
        function mostrarHistorico(idUsuario) {
            ...
            fetch('<?php echo rtrim((string)$BASE_para_URL, '/'); ?>/atendimento/salvar/', {
                    method: 'POST',
                    headers: {
