<nav class="navbar navbar-expand navbar-light navbar-bg">
	<?php
	$ultimoAcessoData = (string)($_SESSION['ultimoAcessoData'] ?? 'Agora');
	$nomeSessao = (string)($_SESSION['Nome'] ?? 'Usuário');
	?>
		...
		<ul class="navbar-nav navbar-align">
						...
						<a href="#" class="list-group-item">
							<div class="row g-0 align-items-center">
								...
								<div class="col-10">
									...
									if ($ultimoAcessoData !== "Agora" && $ultimoAcessoData !== '') {
										$dataUltimoAcesso = new DateTime($ultimoAcessoData);
				...
				<div class="dropdown-menu dropdown-menu-lg dropdown-menu-end py-0" aria-labelledby="messagesDropdown">
					...
					<div class="list-group">
						<a href="#" class="list-group-item">
							<div class="row g-0 align-items-center">
								<div class="col-2">
									<img src="<?php echo $BASE_para_URL; ?>/assets/img/avatars/avatar-5.jpg" class="avatar img-fluid rounded-circle" alt="">
								</div>
						...
						<a href="#" class="list-group-item">
							<div class="row g-0 align-items-center">
								<div class="col-2">
									<img src="<?php echo $BASE_para_URL; ?>/assets/img/avatars/avatar-2.jpg" class="avatar img-fluid rounded-circle" alt="William Harris">
								</div>
								<div class="col-10 ps-2">
						...
						<a href="#" class="list-group-item">
							<div class="row g-0 align-items-center">
								<div class="col-2">
									<img src="<?php echo $BASE_para_URL; ?>/assets/img/avatars/avatar-4.jpg" class="avatar img-fluid rounded-circle" alt="Christina Mason">
								</div>
								<div class="col-10 ps-2">
						...
						<a href="#" class="list-group-item">
							<div class="row g-0 align-items-center">
								<div class="col-2">
									<img src="<?php echo $BASE_para_URL; ?>/assets/img/avatars/avatar-3.jpg" class="avatar img-fluid rounded-circle" alt="Sharon Lessman">
								</div>
								<div class="col-10 ps-2">
			...
			<li class="nav-item dropdown">
				...
				<a class="nav-link dropdown-toggle d-none d-sm-inline-block" href="#" data-bs-toggle="dropdown">
									<img src="<?php echo htmlspecialchars(bootstrap_foto_url((string)($_SESSION['Foto'] ?? '')), ENT_QUOTES, 'UTF-8'); ?>" class="rounded-circle img-cover" width="40px" height="40px" alt="" /> <span class="text-dark"><?php echo htmlspecialchars($nomeSessao, ENT_QUOTES, 'UTF-8'); ?></span>
				</a>
				<div class="dropdown-menu dropdown-menu-end">
					<a class="dropdown-item" href="<?php echo $BASE_para_URL; ?>/perfil"><i class="align-middle me-1" data-feather="user"></i> Perfil</a>
					<a class="dropdown-item" href="<?php echo $BASE_para_URL; ?>/dashboard/"><i class="align-middle me-1" data-feather="pie-chart"></i> Analytics</a>
					<div class="dropdown-divider"></div>
					<a class="dropdown-item" href="<?php echo $BASE_para_URL; ?>/configuracoes"><i class="align-middle me-1" data-feather="settings"></i> Configurações</a>
					<a class="dropdown-item" href="<?php echo $BASE_para_URL; ?>/backup/dados"><i class="align-middle me-1" data-feather="download"></i> Backup dados</a>
					...
					<div class="dropdown-divider"></div>
					<a class="dropdown-item" href="<?php echo $BASE_para_URL; ?>/logout/">Sair</a>
				</div>
			</li>
		</ul>
	</div>
</nav>
<?php require_once $BASE_para_PATH . '/app/views/partials/quick-access.php'; ?>
<script>
