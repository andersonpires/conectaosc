...
$BASE_para_PATH = $runtime['base_para_path'] ?? $runtime['base_para_path'];
$BASE_para_URL = $runtime['base_para_url'] ?? $runtime['base_para_url'];
...
<body>
	...
	<div class="wrapper">
		...
		<div class="main">
			...
			<?php require_once $BASE_para_PATH . '/app/views/partials/corpo.php'; ?>
