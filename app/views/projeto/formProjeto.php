...
$ASSETS_IMG_URL = $runtime['assets_img_url'] ?? (rtrim((string)$BASE_para_URL, '/') . '/assets/img');
        ...
        <div class="main">
            ...
            <main class="content">
                <div class="container-fluid p-0">
                    ...
                    <div class="card mb-4">
                        <div class="card-body">
                            <form action="<?php echo rtrim((string)$BASE_para_URL, '/'); ?>/projetos/" method="post" enctype="multipart/form-data">
                                ...
                                <div class="mb-3">
                                    ...
                                    <?php if (!empty($_POST['LogoProjeto'])): ?>
                                        <div class="mt-2">
                                            <img src="<?php echo rtrim((string)$ASSETS_IMG_URL, '/') . '/logos/' . htmlspecialchars($_POST['LogoProjeto']); ?>" alt="Logo atual" style="max-height:80px;">
                                        </div>
                                    <?php endif; ?>
                                </div>
                                                ...
                                                <tr>
                                                    ...
                                                    <td>
                                                        <?php if (!empty($proj['LogoProjeto'])): ?>
                                                            <img src="<?php echo rtrim((string)$ASSETS_IMG_URL, '/') . '/logos/' . htmlspecialchars($proj['LogoProjeto']); ?>" alt="Logo" style="max-height:40px;">
                                                        <?php else: ?>
                                                            -
                                                        <?php endif; ?>
                                                    </td>
                                                    <td>
                                                        <a class="btn btn-sm btn-warning" href="<?php echo rtrim((string)$BASE_para_URL, '/'); ?>/projetos/?id=<?php echo intval($proj['IdProjeto']); ?>">Editar</a>
                                                        <form action="<?php echo rtrim((string)$BASE_para_URL, '/'); ?>/projetos/" method="post" style="display:inline-block;" onsubmit="return confirm('Excluir este projeto?');">
