...
final class AtendimentoActionFlow
{
    ...
    public function handle(): void
    {
        ...
        switch ($action) {
            ...
            case 'buscarAlunosFaltosos':
                echo json_encode(['status' => 'ok', 'alunos' => $service->buscarAlunosFaltosos($_POST, false)], JSON_UNESCAPED_UNICODE);
                break;
            ...
            case 'dadosAluno':
                ...
                $aluno = $service->dadosAluno($idUsuario, false);
            ...
            case 'salvarNota':
                ...
                if ($salvo['ok'] && !empty($salvo['nomeAluno'])) {
                    require_once $this->basePath . '/app/views/atendimento/notificarUsuario.php';
