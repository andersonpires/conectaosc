...
<head>
    ...
    <script>
        $(document).ready(function() {
            ...
            // Configurar evento de mudanÒ§a no select de cursos
            ...
            // Adiciona classes dinÒ¢micas a botÒµes (se necessÒ¡rio)
...
<script>
    // FunÒ§Ò£o para validar o formulÒ¡rio
    function validarFormulario(event) {
        // Prevenir o envio do formulÒ¡rio
        ...
        // Verificar se os campos estÒ£o preenchidos corretamente
        if (nomeCurso === 'Selecione o curso' || nomeTurma === '' || !dataSelecionada) {
            ...
            // Caso todos os campos sejam vÒ¡lidos, enviar o formulÒ¡rio
            document.querySelector('form').submit();
        }
    }

    // Adicionar o evento de clique ao botÒ£o submit
