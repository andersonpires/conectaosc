...
// Verifica se o usuÒ¡rio selecionou as datas no formulÒ¡rio
...
<style>
    ...
    button.obs-botao:disabled {
        ...
        /* ou 'darkblue' se tiver conteÒºdo */
        pointer-events: none;
        /* Garante que nÒ£o clica */
        border: 1px solid #ccc;
    }
...
<body>
                ...
                <div class="modal-dialog modal-dialog-centered">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            Deseja realmente excluir a presenÒ§a/falta registrada neste dia?
                        </div>
    ...
    <script src="<?php echo $_SESSION['BASE_para_URL']; ?>/assets/js/filtroChamadaTotal.js"></script>
    ...
    <script>
        $(document).ready(function() {
            $.ajax({
                ...
                success: function(response) {
                    try {
                        ...
                        if (Array.isArray(dados)) {
                            ...
                            updateTabelaChamada(); // importante para recalcular contadores e filtros apÒ³s carregar
                        }
                    } catch (e) {
                ...
                error: function() {
                    console.error("Erro na requisiÒ§Ò£o loadHistoricoData");
                }
            });
        });
    </script>
                ...
                $.ajax({
                    ...
                    success: function(resposta) {
                        try {
                            ...
                            if (res.success) {
                                toastr.success("Registro excluÒ­do com sucesso!");
