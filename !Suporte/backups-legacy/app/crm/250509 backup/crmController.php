...
switch ($action) {
    ...
    case 'marcarFeito':
        ...
        if ($id) {
            ...
            echo json_encode(['status' => 'erro', 'mensagem' => 'ID invÒ�� �"Ò⬠â����Ò�â��šÒ�a�¡lido']);
        }
        break;
    ...
    case 'dadosAluno':
        ...
        if (!$idUsuario) {
            echo json_encode(['status' => 'erro', 'mensagem' => 'ID do aluno nÒ�� �"Ò⬠â����Ò�â��šÒ�a�£o fornecido']);
            exit;
        }
        ...
        if ($aluno) {
            ...
            echo json_encode(['status' => 'erro', 'mensagem' => 'Aluno nÒ�� �"Ò⬠â����Ò�â��šÒ�a�£o encontrado']);
        }
        break;
    ...
    case 'listarNotasAluno':
        ...
        if (!$idUsuario) {
            echo json_encode(['status' => 'erro', 'mensagem' => 'ID do aluno invÒ�� �"Ò⬠â����Ò�â��šÒ�a�¡lido']);
            break;
        }
    ...
    case 'uploadImagemNota':
        // Permite origens especÒ�� �"Ò⬠â����Ò�â��šÒ�a�­ficas se for usar CORS (opcional)
        $accepted_origins = [
            "http://localhost",
            "http://127.0.0.1",
            "http://localhost:8080", // adicione outras origens conforme necessÒ�� �"Ò⬠â����Ò�â��šÒ�a�¡rio
            $_SERVER['HTTP_ORIGIN'] ? ''
        ];
        ...
        if (!in_array($extensao, $extPermitidas)) {
            http_response_code(400);
            echo json_encode(['error' => 'ExtensÒ�� �"Ò⬠â����Ò�â��šÒ�a�£o de arquivo invÒ�� �"Ò⬠â����Ò�â��šÒ�a�¡lida']);
            exit;
        }

        // Gera nome Ò�� �"Ò⬠â����Ò�â��šÒ�a�ºnico
        ...
        $urlFinal = $protocolo . $host . $_SESSION['BASE_para_URL'] . '/app/assets/img/notas/' . $nome;

        // Limpa qualquer saÒ�� �"Ò⬠â����Ò�â��šÒ�a�­da anterior
    ...
    case 'salvarNota':
        ...
        if (!$idUsuario) {
            echo json_encode(['status' => 'erro', 'mensagem' => 'Sem Id UsuÒ�� �"Ò⬠â����Ò�â��šÒ�a�¡rio']);
            break;
        }
        if (!$idColaborador) {
        ...
        if ($sucesso && $aluno) {
            ...
            $mensagemNotificacao =  notificarUsuario($pdo, $idColaborador, 'nota', $aluno['Nome']); // Chama notificaÒ�� �"Ò⬠â����Ò�â��šÒ�a�§Ò�� �"Ò⬠â����Ò�â��šÒ�a�£o
        }
    ...
    case 'salvarTarefa':
        ...
        if (!$idUsuario || !$idColaborador || empty($descricaoTarefa) || empty($dataExecucao)) {
            echo json_encode(['status' => 'erro', 'mensagem' => 'Preencha todos os campos obrigatÒ�� �"Ò⬠â����Ò�â��šÒ�a�³rios.']);
            break;
        }
    ...
    case 'dadosColaborador':
        ...
        if ($id) {
            ...
            echo json_encode(['status' => 'erro', 'mensagem' => 'UsuÒ�� �"Ò⬠â����Ò�â��šÒ�a�¡rio nÒ�� �"Ò⬠â����Ò�â��šÒ�a�£o autenticado']);
        }
        break;
    ...
    case 'getPreferenciasNotificacao':
        ...
        if (!$id) {
            echo json_encode(['status' => 'erro', 'mensagem' => 'Colaborador nÒ�� �"Ò⬠â����Ò�â��šÒ�a�£o identificado']);
            break;
        }
        ...
        // Busca ou cria a preferÒ�� �"Ò⬠â����Ò�â��šÒ�a�ªncia
    ...
    default:
        echo json_encode(['status' => 'erro', 'mensagem' => 'AÒ�� �"Ò⬠â����Ò�â��šÒ�a�§Ò�� �"Ò⬠â����Ò�â��šÒ�a�£o invÒ�� �"Ò⬠â����Ò�â��šÒ�a�¡lida']);
        break;
}
