...
$mensagem = " OlÒ��¡, " . $nome . ". VocÒ��ª acabou de cadastrar uma nota! (" . $agora . ")";
...
echo $resposta;
$dados_string = print_r($dados, true) . PHP_EOL; // Adiciona uma nova linha para melhor formataÒ��§Ò��£o

$arquivo = fopen('error.txt', 'a'); // Abre o arquivo em modo de anexaÒ��§Ò��£o
