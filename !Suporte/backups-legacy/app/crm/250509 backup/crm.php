...
// Verifica se as variÒ�� �"Ò�a�¡veis de sessÒ�� �"Ò�a�£o BASE_para_PATH e BASE_para_URL estÒ�� �"Ò�a�£o definidas
if (!isset($_SESSION['BASE_para_PATH']) || !isset($_SESSION['BASE_para_URL'])) {
    // Salva a URL atual para redirecionar o usuÒ�� �"Ò�a�¡rio apÒ�� �"Ò�a�³s o login
    $redirect_url = urlencode($_SERVER['REQUEST_URI']); // Codifica o endereÒ�� �"Ò�a�§o atual
    header("Location:" . dirname($_SERVER['SERVER_NAME']) . "/../../login.php?redirect=$redirect_url"); // Redireciona para o login com o endereÒ�� �"Ò�a�§o de volta via GET
    exit(); // Garante que o cÒ�� �"Ò�a�³digo abaixo nÒ�� �"Ò�a�£o serÒ�� �"Ò�a�¡ executado
}
...
// Verifica existencia de API Zap
$ativaZap = '';
$stmt2 = $pdo->query("SELECT APIzap FROM tbConfig LIMIT 1")->fetch(PDO::FETCH_ASSOC);
$desabilita = '';
if ($stmt2['APIzap'] == null) {
    $desabilita = 'disabled';
}
?>
<!DOCTYPE html>
...
<head>
    ...
    <link rel="stylesheet" href="<?php echo $_SESSION['BASE_para_URL']; ?>/assets/css/overlayNotifica.css">
            ...
            images_upload_handler: (blobInfo, progress) => new Promise((resolve, reject) => {
                ...
                xhr.onload = () => {
                    ...
                    if (!json || typeof json.location !== 'string') {
                        reject('Resposta invÒ�� �"Ò�a�¡lida: ' + xhr.responseText);
                        return;
                    }
                ...
                xhr.onerror = () => {
                    reject('Erro de conexÒ�� �"Ò�a�£o. CÒ�� �"Ò�a�³digo: ' + xhr.status);
                };
    ...
    <script>
        function mostrarDiv(area) {
            ...
            if (target) {
                ...
                console.warn('Div nÒ�� �"Ò�a�£o encontrada:', id);
            }
        }
        ...
        function carregarTurmas() {
            ...
            if (idCurso == 0) {
                ...
                fetch('<?php echo $_SESSION['BASE_para_URL']; ?>/get/getTurmasNome.php?IdCurso=all')
                    .then(res => res.text())
                    .then(html => {
            ...
            // Curso especÒ�� �"Ò�a�­fico
            // Para curso especÒ�� �"Ò�a�­fico
            fetch('<?php echo $_SESSION['BASE_para_URL']; ?>/get/getTurmasNome.php?IdCurso=' + idCurso)
                .then(res => res.text())
                .then(html => {
                    turmaSelect.disabled = false;
...
<body>
        ...
        <div class="main">
            ...
            <main class="content">
                <div class="container-fluid mt-4">
                    ...
                    <!-- BotÒ�� �"Ò�a�µes de AÒ�� �"Ò�a�§Ò�� �"Ò�a�£o -->
                    <div class="mb-3 d-flex gap-2">
                        ...
                        <button class="btn btn-secondary btn-sm" onclick="mostrarDiv('timeline')">
                            <i class="fa-solid fa-clock-rotate-left"></i> Ver HistÒ�� �"Ò�a�³rico
                        </button>
                        <button class="btn btn-warning btn-sm" onclick="mostrarDiv('notificacoes')">
                            <i class="fa-solid fa-bell"></i> NotificaÒ�� �"Ò�a�§Ò�� �"Ò�a�µes
                        </button>
                    </div>

                    <!-- Ò�� �"Ò�a�rea de Tarefas -->
                            ...
                            <div class="card-body table-responsive">
                                <div class="d-flex justify-content-between align-items-center mb-2">
                                    <div>
                                        ...
                                        <select id="filtroNotificado" class="form-select form-select-sm d-inline-block w-auto">
                                            <option value="0" selected>NÒ�� �"Ò�a�£o notificadas</option>
                                ...
                                <table class="table table-striped table-hover">
                                    <thead>
                                        <tr>
                                            <th>Aluno</th>
                                            <th>DescriÒ�� �"Ò�a�§Ò�� �"Ò�a�£o</th>
                                            <th>ResponsÒ�� �"Ò�a�¡vel</th>
                                            <th>Data/Hora</th>
                                            <th>Status</th>
                                            <th>AÒ�� �"Ò�a�§Ò�� �"Ò�a�µes</th>
                                        </tr>
                                    </thead>
                                    <tbody id="tabelaTarefasBody">
                                        <!-- Linhas de tarefas serÒ�� �"Ò�a�£o inseridas aqui via PHP ou JS -->
                                    </tbody>
                                </table>
                            </div>
                        </div>
                    ...
                    <div id="divBusca" style="display: none;">
                        <div class="card shadow-lg">
                            ...
                            <div class="card-body">
                                <!-- FormulÒ�� �"Ò�a�¡rio de busca e exibiÒ�� �"Ò�a�§Ò�� �"Ò�a�£o dos cards aqui -->
                                <form id="formBusca" class="row mb-4">
                                    ...
                                    <div class="col-md-2">
                                        <label class="form-label" for="dias">Nos Ò�� �"Ò�a�ºltimos (dias)</label>
                                ...
                                <!-- Aqui serÒ�� �"Ò�a�£o carregados os cards -->
                                <div class="row" id="cardsAlunos">
                                    <!-- Cards serÒ�� �"Ò�a�£o inseridos via JS -->
                                </div>
                    ...
                    <!-- Ò�� �"Ò�a�rea de Timeline (Notas e HistÒ�� �"Ò�a�³rico de InteraÒ�� �"Ò�a�§Ò�� �"Ò�a�£o) -->
                    <div id="divTimeline" style="display: none;">
                        <div class="card shadow-lg">
                            <div class="card-header bg-secondary text-white">
                                HistÒ�� �"Ò�a�³rico de InteraÒ�� �"Ò�a�§Ò�� �"Ò�a�µes
                            </div>
                    ...
                    <!-- Ò�� �"Ò�a�rea de NotificaÒ�� �"Ò�a�§Ò�� �"Ò�a�µes -->
                    <div id="divNotificacoes" style="display: none;">
                        <div class="card shadow-lg">
                            <div class="card-header bg-warning text-dark">
                                NotificaÒ�� �"Ò�a�§Ò�� �"Ò�a�µes
                            </div>
                            <div class="card-body">
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="form-check">
                                            ...
                                            <label class="form-check-label" for="nota_email">
                                                E-mail: <span id="emailUsuario"></span> <a href="<?php echo $_SESSION['BASE_para_URL']; ?>/app/perfil/perfilController.php?m=mail">(mudar)</a>
                                            </label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="nota_whatsapp" <?= $desabilita ?>>
                                            <label class="form-check-label" for="nota_whatsapp">
                                                WhatsApp: <span id="zapUsuario"></span> <a href="<?php echo $_SESSION['BASE_para_URL']; ?>/app/perfil/perfilController.php?m=ws" <?php echo ($ativaZap == false) ? 'disabled' : ''; ?>>(mudar)</a>
                                            </label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="form-check">
                                            ...
                                            <label class="form-check-label" for="tarefa_email">
                                                E-mail: <span id="emailUsuario2"></span> <a href="<?php echo $_SESSION['BASE_para_URL']; ?>/app/perfil/perfilController.php?m=mail">(mudar)</a>
                                            </label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="tarefa_whatsapp" <?= $desabilita ?>>
                                            <label class="form-check-label" for="tarefa_whatsapp">
                                                WhatsApp: <span id="zapUsuario2"></span> <a href="<?php echo $_SESSION['BASE_para_URL']; ?>/app/perfil/perfilController.php?m=ws" <?php echo ($ativaZap == false) ? 'disabled' : ''; ?>>(mudar)</a>
                                            </label>
                                        </div>
                                    </div>
    ...
    <script src="<?php echo $_SESSION['BASE_para_URL']; ?>/assets/js/overlayNotifica.js"></script>
                    ...
                    if (data.status === 'ok') {
                        ...
                        fichaDiv.innerHTML = `
                                                <div class="d-flex align-items-center mb-3">
                                                    <img src="${a.Foto ? '<?php echo $_SESSION['BASE_para_URL']; ?>/assets/img/fotos/' + a.Foto : '<?php echo $_SESSION['BASE_para_URL']; ?>/assets/img/fotos/padrao.jpg'}" class="rounded-circle me-3" width="80" height="80">
                                                    <div>
                                                        ...
                                                        <small><strong>Contatos: </strong>
                                                            ${a.Telefone ? `${a.Telefone} (sÒ�� �"Ò�a�³ telefone)` : ''}
                                                            ${a.Telefone && a.WhatsApp ? ' | ' : ''}
                                                            ${a.WhatsApp ? `${a.WhatsApp} (telefone e WhatsApp)` : ''}
                                                        </small><br>

                                                        <small><strong>EndereÒ�� �"Ò�a�§o: </strong>${a.Endereco}, ${a.Bairro}, ${a.Cidade}-${a.UF}</small><br>
            ...
            fetch('crmController.php', {
                ...
                .then(data => {
                    if (data.status === 'ok') {
                        ...
                        let html = '<h6 class="mt-4">HistÒ�� �"Ò�a�³rico de Notas</h6>';
            ...
            fetch('crmController.php', {
                ...
                .then(data => {
                    if (data.status === 'ok') {
                        ...
                        container.innerHTML = `<h6 class="mt-4">HistÒ�� �"Ò�a�³rico de Notas</h6>`;
    ...
    <script>
            ...
            if (urlParams.has('idUsuario')) {
                ...
                fetch('crmController.php', {
                    ...
                    .then(data => {
                        ...
                        console.error('Erro na requisiÒ�� �"Ò�a�§Ò�� �"Ò�a�£o:', error);
                    });

            } else {
                mostrarDiv('tarefas'); // padrÒ�� �"Ò�a�£o
            }
            ...
            fetch('crmController.php', {
                ...
                .then(data => {
                    ...
                    if (data.status === 'ok' && data.alunos.length > 0) {
                        data.alunos.forEach(aluno => {
                            ...
                            card.innerHTML = `
                                            <div class="d-flex shadow-lg rounded mb-3 p-2 bg-light align-items-start justify-content-between card-hover">
                                                <img src="<?php echo $_SESSION['BASE_para_URL']; ?>/assets/img/fotos/${aluno.Foto || 'padrao.jpg'}" class="rounded-circle me-3" width="50" height="50" alt="Foto">
                        ...
                        container.innerHTML = '<div class="alert alert-warning">Nenhum aluno encontrado com os critÒ�� �"Ò�a�©rios informados.</div>';
                        document.getElementById('resultadoBuscaCount').textContent = 'Nenhum aluno encontrado com os critÒ�� �"Ò�a�©rios informados.';
                    }
                });
        }
        ...
        function salvarPreferencias(mostrarMensagem = false) {
            ...
            if (mostrarMensagem) {
                msgEl.innerHTML = `<div class="spinner-border spinner-border-sm text-primary me-2" role="status"></div> Salvando preferÒ�� �"Ò�a�ªncias...`;
            }
                ...
                .then(data => {
                    if (data.status === 'ok' && mostrarMensagem) {
                        ...
                        const intervalo = setInterval(() => {
                            msgEl.textContent = `PreferÒ�� �"Ò�a�ªncias salvas com sucesso! ${contador}`;
                            contador--;
                            if (contador < 0) {
