<?php
// InÒ��­cio da pÒ��¡gina: inicializaÒ��§Ò��£o de session e configuraÒ��§Ò��£o de timezone
...
?>
<?php //require_once $_SESSION['BASE_para_PATH'] . '/api/legacy/checa-token.php'; ?>
<!DOCTYPE html>
<html lang="pt-BR">
...
<head>
    ...
    <style>
        ...
        .table-layout-auto {
            ...
            width: 100%;
            white-space: nowrap;
            /* Impede quebra de linha nas cÒ��©lulas */
        }
        ...
        <div class="main">
            ...
            <main class="content">
                <div class="container-fluid p-0">
                    <h1 class="h3 mb-3">UsuÒ��¡rios do Sistema</h1>
                    <?php
                    ...
                    if (strpos($urlDecoded, '=') !== false) {
                        ...
                        $tipomsg = explode('?', $params[0])[1]; // Pega o valor apÒ��³s o '?'
                        $tipomsg = explode('=', $tipomsg)[0]; // Pega o valor antes do '='
                        $msg = explode('=', $params[0])[1]; // Pega o valor apÒ��³s o '='
                    }
                    if ($msg != "") {
                        if ($tipomsg == "msg") {
                    ?>
                    ...
                    // ConexÒ��£o com o banco utilizando PDO
                    require_once $_SESSION['BASE_para_PATH'] . '/api/conectabd/conexao.php';

                    // Se existir POST com IdColaborador, exibe formulÒ��¡rio para alteraÒ��§Ò��£o
                                        ...
                                        <form action="alteraColaborador.php" enctype="multipart/form-data" method="post" onsubmit="mostrarOverlay({ mensagem: 'Alterando dados...', carregando: true })">
                                            ...
                                            <div class="row mb-3">
                                                ...
                                                <div class="col-5">
                                                    ...
                                                    <input type="text" class="form-control" id="Senha" name="Senha" value="Apenas o usuÒ��¡rio pode alterar a senha" readonly autocomplete="off">
                                                </div>
                                            </div>
                                            <div class="mb-3">
                                                ...
                                                <img src="<?php echo $_SESSION['BASE_para_URL']; ?>/assets/img/fotos/<?php echo $colaborador['Foto']; ?>" id="fotoedit" class="rounded-circle img-cover fotografia" width="100px" height="100px">
                                                <p></p>
                                ...
                                <table id="minhaTabela" class="table table-striped table-hover datatable-custom table-layout-auto">
                                    ...
                                    <tbody>
                                        ...
                                        ?>
                                                <tr>
                                                    <td>
                                                        <img src="<?php echo $_SESSION['BASE_para_URL']; ?>/assets/img/fotos/<?php echo $Foto ?>" class="rounded-circle img-cover" width="40px" height="40px">
                                                    </td>
                                                    <td><?php echo $Nome ?></td>
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h1 class="modal-title fs-5" id="exampleModalLabel">Excluir usuÒ��¡rios</h1>
                                            ...
                                            <form action="excluirColaborador.php" method="post" onsubmit="mostrarOverlay({ mensagem: 'Excluindo dados...', carregando: true })">
                                                ...
                                                <div class="row mb-3">
                                                    <div style="text-align: center;" class="mb-3">
                                                        <label for="foto" class="form-label">Foto usuÒ��¡rio</label>
                                                        <br>
                                                        <img src="<?php echo $_SESSION['BASE_para_URL']; ?>/assets/img/fotos/<?php echo $Foto ?>" id="foto" class="rounded-circle img-cover fotografia" width="100px" height="100px">
                                                        <br>
                                                    </div>
                                                </div>
                                        </div>
...
<script>
    $(document).ready(function() {
        $('#minhaTabela').DataTable({
            "pageLength": 50,
            "scrollX": true, // Adiciona barra de rolagem lateral se necessÒ��¡rio
...
<!-- ImportaÒ��§Ò��£o do Jquery Mask -->
<!-- include da importaÒ��§Ò��£o da mascara dos inputs -->
...
<script>
    $(function() {
        $('#excluirModal').on('show.bs.modal', function(event) {
            ...
            for (var i = 0; i < imagens.length; i++) {
                imagens[i].setAttribute('src', '<?php echo $_SESSION['BASE_para_URL'] . '/app/assets/img/fotos/' ?>' + foto);
            }
        });
    });
</script>

<!-- Cria o <form> para o botÒ��£o Alterar -->
<script>
    function alterarColaborador(id) {
        const form = document.createElement('form');
        form.method = 'POST';
        form.action = 'formColaborador.php'; // Envia para o prÒ��³prio arquivo
        ...
        if (file && ['image/jpeg', 'image/png', 'image/jpg'].includes(file.type)) {
            ...
            reader.onload = (e) => {
                ...
                cropper = new Cropper(preview, {
                    aspectRatio: 1, // ProporÒ��§Ò��£o ajustÒ��¡vel
                    viewMode: 1,
                    ready() {
                        // Salvar automaticamente apÒ��³s inicializaÒ��§Ò��£o
                        saveCroppedImage();
                    },
                    crop() {
                        // Salvar automaticamente em cada modificaÒ��§Ò��£o
                        saveCroppedImage();
                    }
                });
            };
