...
<body>
        ...
        <div class="main">
            ...
            <main class="content">
                <div class="container-fluid p-0">
                    <h1 class="h3 mb-3">RelatÒ³rio Personalizado de Alunos</h1>
                    <div class="card">
                        <div class="card-body">
                                ...
                                <div class="row mb-3">
                                    ...
                                    <div class="col-md-4 d-flex align-items-end">
                                        <div class="form-check">
                                            ...
                                            <label class="form-check-label" for="matriculasAtivas">MatrÒ­culas ativas</label>
                                        </div>
                                    </div>
                                </div>
    ...
    <script>
        $('#curso').change(function() {
            ...
            $.post('<?php echo $_SESSION['BASE_para_URL']; ?>/get/getTurmas.php', {
                IdCurso: idCurso
            }, function(data) {
        ...
        function gerarExcel(dados, nomeArquivo) {
            ...
            XLSX.utils.book_append_sheet(wb, ws, "RelatÒ³rio Personalizado");
            XLSX.writeFile(wb, nomeArquivo);
        }

        $('#exportarExcel').click(function() {
            const formData = $('#customForm').serialize();
            $.post('<?php echo $_SESSION['BASE_para_URL']; ?>/get/getCustomAlunoJson.php', formData, function(response) {
                gerarExcel(response, 'RelatorioCustomizado.xlsx');
            }, 'json').fail(function() {
                alert('Erro ao gerar relatÒ³rio.');
            });
        });

        $('#gerarHtml').click(function() {
            const formData = $('#customForm').serialize();
            $.post('<?php echo $_SESSION['BASE_para_URL']; ?>/get/getCustomAlunoHTML.php', formData, function(html) {
