    ...
    if (!empty($_POST['email']) && !empty($_POST['password'])) {
        ...
        if ($result) {
            ...
            if (password_verify($senhaDigitada, $hashed_password)) {
                // Credenciais vÒ¡lidas, armazena os detalhes do usuÒ¡rio na sessÒ£o
                $hora_atual = time() * 10;
                $mes_atual = date("M");
                ...
                // Redireciona para a pÒ¡gina principal apÒ³s o login
                header("Location: " . rtrim((string)$BASE_para_URL, '/') . "/dashboard/");
                exit();
            } else {
                // Credenciais invÒ¡lidas, exibe um alerta de erro
                echo "<script>alert('E-mail ou senha incorretos. Tente novamente.');</script>";
                die;
            }
        } else {
            // UsuÒ¡rio nÒ£o encontrado, exibe um alerta de erro
            echo "<script>alert('E-mail ou senha nÒ£o conferem.');</script>";
            die;
        }
    } else {
        // Caso os campos nÒ£o tenham sido preenchidos, exibe um alerta de erro
...
<head>
    ...
    <title>Login | ITEVA - GestÒ£o de OSCs</title>
                ...
                <div class="col-sm-9 col-md-7 col-lg-5 mx-auto d-table h-100">
                    <div class="d-table-cell align-middle">
                        <div class="text-center mt-4">
                            ...
                            <p class="lead texto">FaÒ§a login em sua conta para continuar</p>
                        </div>
                                    ...
                                    <form method="post" action="">
                                        ...
                                        <div>
                                            <label class="form-check">
                                                ...
                                                <span class="form-check-label">Lembre-se de mim da prÒ³xima vez</span>
                                                <p><br></p>
                                            </label>
                                        </div>
