<!-- SERVI?O DE INSCRI??O EVENTO 3O SETOR - FORM PARA INSCRI??O -->
            ...
            <main class="content">
                <div class="container-fluid p-0">
                    ...
                    <div class="container mt-5">
                        ...
                        <form id="formulario" action="cadInscrito.php" method="POST">

                            <div class="card shadow-lg">
                                <div class="card-body">
                                    <!-- Nome Completo -->
                                    <span style="font-style: italic;">Os itens com asterico (*) sóo de preenchimento obrigat?rio.</span>
                                    <p></p>
                                    <div class="mb-3">
    ...
    <!-- <script>
        document.addEventListener('DOMContentLoaded', function() {
            ...
            function validateForm() {
                // Verifica se todos os campos obrigat?rios estáo preenchidos e v?lidos
            ...
            // Adiciona evento de validação em todos os campos do formul?rio
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            async function checkEmailExists(email) {
                try {
                    const response = await fetch("verifica_email.php?email=" + encodeURIComponent(email));
            ...
            // Fun??o para validar os campos obrigat?rios e ativar/desativar bot?o de envio
            async function validateFields() {
                ...
                // Verifica se o telefone cont?m apenas n?meros e tem no m?nimo 10 d?gitos
                const telefoneRegex = /^[0-9]{10,}$/;
                const telefoneSomenteNumeros = telefoneField.value.replace(/\D/g, ""); // Remove tudo que não ? n?mero
                if (!telefoneRegex.test(telefoneSomenteNumeros)) {
                    allValid = false;
                    telefoneField.classList.add("is-invalid");
                    telefoneError.innerText = "O telefone deve ter pelo menos 10 n?meros.";
                } else {
                    telefoneField.classList.remove("is-invalid");
                    telefoneError.innerText = "";
                }

                // Se tudo estiver correto, habilita o bot?o, senão desabilita
            ...
            // Validação final no envio do formul?rio
            form.addEventListener("submit", async function(event) {
                event.preventDefault(); // Impede envio inicial
                await validateFields(); // Confirma que os campos estáo corretos
