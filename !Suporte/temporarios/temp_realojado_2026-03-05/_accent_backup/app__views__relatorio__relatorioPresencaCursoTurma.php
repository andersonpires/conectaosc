        ...
        <div class="main">
            ...
            <main class="content">
                <div class="container-fluid p-0">
                    <h1 class="h3 mb-3">Relat?f?????T?f?????,????f???,?s?f??s?,?rio de Presen?f?????T?f?????,????f???,?s?f??s?,?a por Curso e Turma</h1>
                    <div class="card">
                        <div class="card-body">
                            <form id="filtroPresenca" class="row g-3 mb-3">
                                <div class="col-md-3">
                                    <label for="dataInicio" class="form-label">Data In?f?????T?f?????,????f???,?s?f??s?,?cio</label>
                                ...
                                <div class="col-md-12">
                                    ...
                                    <?php
                                    $dias = ['DOM' => 'Dom', 'SEG' => 'Seg', 'TER' => 'Ter', 'QUA' => 'Qua', 'QUI' => 'Qui', 'SEX' => 'Sex', 'SAB' => 'S?f?????T?f?????,????f???,?s?f??s?,?b'];
    ...
    <script>
        $(document).ready(function() {
            ...
            $('#curso').change(function() {
                ...
                $.post('<?php echo $BASE_URL; ?>/get/getTurmasPorCursoHTML.php', {
                    IdCurso: idCurso
                }, function(data) {
            ...
            $('#gerarHTML').click(function() {
                ...
                $.post('<?php echo $BASE_URL; ?>/get/getRelatorioPresencaCursoTurmaHTML.php', dados, function(html) {
            ...
            $('#gerarExcel').click(function() {
                const dados = $('#filtroPresenca').serialize();
                $.post('<?php echo $BASE_URL; ?>/get/getRelatorioPresencaCursoTurmaJson.php', dados, function(json) {
                    ...
                    XLSX.utils.book_append_sheet(wb, ws, "Presen?f?????T?f?????,????f???,?s?f??s?,?as");
