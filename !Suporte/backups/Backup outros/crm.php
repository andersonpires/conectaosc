                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="form-check">
                                            ...
                                            <label class="form-check-label" for="nota_email">
                                                E-mail: <span id="emailUsuario"></span> <a href="<?php echo $_SESSION['BASE_para_URL']; ?>/app/perfil/perfil.php?m=mail">(mudar)</a>
                                            </label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="nota_whatsapp">
                                            <label class="form-check-label" for="nota_whatsapp">
                                                WhatsApp: <span id="zapUsuario"></span> <a href="<?php echo $_SESSION['BASE_para_URL']; ?>/app/perfil/perfil.php?m=ws">(mudar)</a>
                                            </label>
                                        </div>
                                    </div>
                                    ...
                                    <div class="mb-3">
                                        ...
                                        <div class="form-check">
                                            ...
                                            <label class="form-check-label" for="tarefa_email">
                                                E-mail: <span id="emailUsuario2"></span> <a href="<?php echo $_SESSION['BASE_para_URL']; ?>/app/perfil/perfil.php?m=mail">(mudar)</a>
                                            </label>
                                        </div>
                                        <div class="form-check">
                                            <input class="form-check-input" type="checkbox" id="tarefa_whatsapp">
                                            <label class="form-check-label" for="tarefa_whatsapp">
                                                WhatsApp: <span id="zapUsuario2"></span> <a href="<?php echo $_SESSION['BASE_para_URL']; ?>/app/perfil/perfil.php?m=ws">(mudar)</a>
                                            </label>
                                        </div>
                                    </div>
