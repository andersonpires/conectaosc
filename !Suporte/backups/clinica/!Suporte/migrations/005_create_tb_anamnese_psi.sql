-- Migration 005: Tabela tb_anamnese_psi - Anamnese psicol�gica
-- App Cl�nica - ConectaOSC
-- Execute via: 005_run_create_tb_anamnese_psi.php

SET NAMES utf8mb4;
SET FOREIGN_KEY_CHECKS = 0;

CREATE TABLE IF NOT EXISTS tb_anamnese_psi (
    ...
    -- 4 - ASPECTOS CL�NICOS E SA�DE MENTAL
    ...
    -- 5 - QUEST�ES DE SA�DE F�SICA E FUNCIONALIDADE
    ...
    -- 6 - FUNCIONALIDADE COGNITIVA (Respondeu adequadamente / N�o respondeu adequadamente)
    ...
    -- 7 - RISCO E PROTE��O PSICOSSOCIAL
    ...
    -- 9 - MEM�RIA, COTIDIANO E EXPECTATIVAS
    ...
    -- 10 - OBSERVA��ES E IMPRESS�ES GERAIS
