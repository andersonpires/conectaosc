...
- NUNCA incluir renda do paciente. ";
    ...
    public function gerarIa(): void
    {
        ...
        if (!empty($aluno['AvaliacaoVulnerabilidadeIA'])) {
            $descricaoAluno .= "\nAVALIA�!ÒO SOCIOASSISTENCIAL (resumo): " . substr(trim($aluno['AvaliacaoVulnerabilidadeIA']), 0, 3000) . "\n";
        }
        ...
        $instrucaoHistorico = $ehPrimeiroProntuario
            ? " NÒO inclua o tópico HIST�RICO pois é o primeiro prontuário deste paciente."
            : " Inclua o tópico HIST�RICO com base nos prontuários anteriores fornecidos.";
