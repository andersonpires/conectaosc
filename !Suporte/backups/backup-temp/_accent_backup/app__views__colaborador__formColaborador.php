                ...
                <div class="container-fluid p-0">
                    ...
                    ?>
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <form action="<?php echo rtrim((string)$BASE_URL, '/'); ?>/colaboradores/" enctype="multipart/form-data" method="post" onsubmit="mostrarOverlay({ mensagem: 'Alterando dados...', carregando: true })">
...
<?php if (false): ?>
                                        <div class="mb-3">
                                            <label for="especialidade_id" class="form-label">Especialidade (App Cl?f?????T?f?????,????f???,?s?f??s?,?nica)</label>
                                        ...
                                        <div class="row mb-3">
                                            ...
                                            <div class="col-5">
                                                ...
                                                <input type="text" class="form-control" id="Senha" name="Senha" value="Apenas o usuario pode alterar a senha" readonly autocomplete="off">
                                            </div>
                                        </div>
                                        <div class="mb-3">
                                            <label for="fotoedit" class="form-label">Foto colaborador</label>
                                            <br>
                                            <img src="<?php echo $BASE_URL; ?>/assets/img/fotos/<?php echo $colaborador['Foto']; ?>" id="fotoedit" class="rounded-circle img-cover fotografia" width="100px" height="100px">
                                            <p></p>
                    ...
                    <?php } else { ?>
                        <div class="col-12">
                            <div class="card">
                                <div class="card-body">
                                    <form action="<?php echo rtrim((string)$BASE_URL, '/'); ?>/colaboradores/" enctype="multipart/form-data" method="post" onsubmit="mostrarOverlay({ mensagem: 'Salvando dados...', carregando: true })">
                                        <div class="row mb-3">
                                            <div class="col-5">
                                                <label for="Nome" class="form-label">Nome</label>
                    ...
                    <div class="card">
                        <div class="card-header d-flex flex-wrap align-items-center gap-2">
                            ...
                            <div class="btn-group ms-auto" role="group" aria-label="Filtro de status">
                                <a href="<?php echo rtrim((string)$BASE_URL, '/'); ?>/colaboradores/?status=ativos" class="btn btn-sm <?php echo ($statusFiltro ?? 'ativos') === 'ativos' ? 'btn-primary' : 'btn-outline-primary'; ?>">Ativos</a>
                                <a href="<?php echo rtrim((string)$BASE_URL, '/'); ?>/colaboradores/?status=inativos" class="btn btn-sm <?php echo ($statusFiltro ?? 'ativos') === 'inativos' ? 'btn-primary' : 'btn-outline-primary'; ?>">Inativos</a>
                            </div>
                        </div>
                        <div class="card-body">
                                ...
                                <table id="minhaTabela" class="table table-striped table-hover datatable-custom table-layout-auto">
                                    ...
                                    <tbody>
                                            ...
                                            <?php foreach ($listaColaboradores as $dados): ?>
                                                ...
                                                <tr>
                                                    <td>
                                                        <img src="<?php echo $BASE_URL; ?>/assets/img/fotos/<?php echo htmlspecialchars($Foto); ?>" class="rounded-circle img-cover" width="40px" height="40px">
                                                    </td>
                                                    ...
                                                    <td>
                                                        ...
                                                        <?php else: ?>
                                                            <form action="<?php echo rtrim((string)$BASE_URL, '/'); ?>/colaboradores/" method="post" style="display:inline-block;">
                                ...
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        <div class="modal-header">
                                            <h1 class="modal-title fs-5" id="exampleModalLabel">Inativar usuario</h1>
                                            <button type="button" class="btn-close" data-bs-dismiss="modal" aria-label="Close"></button>
                                        </div>
                                        <div class="modal-body">
                                            <form action="<?php echo rtrim((string)$BASE_URL, '/'); ?>/colaboradores/" method="post" onsubmit="mostrarOverlay({ mensagem: 'Inativando usuario...', carregando: true })">
                                                ...
                                                <div class="row mb-3">
                                                    <div style="text-align: center;" class="mb-3">
                                                        <label for="foto" class="form-label">Foto usu?f?????T?f?????,????f???,?s?f??s?,?rio</label>
                                                        <br>
                                                        <img src="<?php echo $BASE_URL; ?>/assets/img/fotos/<?php echo $Foto ?>" id="foto" class="rounded-circle img-cover fotografia" width="100px" height="100px">
                                                        <br>
                                                    </div>
                                                </div>
                                        </div>
...
<script>
    $(function() {
        $('#excluirModal').on('show.bs.modal', function(event) {
            ...
            var modal = $(this)
            //aplica valor ao id
            modal.find('.modal-title').text('Inativar usuario')
...
<script>
    function alterarColaborador(id) {
        ...
        form.method = 'POST';
        form.action = '<?php echo rtrim((string)$BASE_URL, '/'); ?>/colaboradores/';
