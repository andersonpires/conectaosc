            ...
            <script>
                document.addEventListener("DOMContentLoaded", function() {
                    ...
                    document.getElementById("datetimepicker-dashboard").flatpickr({
                        locale: "pt",
                        inline: true,
                        prevArrow: "<span title=\"M?f?????T?f?????,????f???,?s?f??s?,?s anterior\">&laquo;</span>",
                        nextArrow: "<span title=\"Pr?f?????T?f?????,????f???,?s?f??s?,?ximo m?f?????T?f?????,????f???,?s?f??s?,?s\">&raquo;</span>",
                    ...
                    <div class="row">
                        <div class="col-md-4 col-xl-3">
                            <div class="card mb-3">
                                <div class="card-body">
                                    ...
                                    <ul class="list-unstyled mb-0">
                                        ...
                                        if ($_SERVER['REQUEST_METHOD'] === 'POST') {
                                            ...
                                            echo "M?f?????T?f?????,????f???,?s?f??s?,?todo inv?f?????T?f?????,????f???,?s?f??s?,?lido. Por favor, envie os dados via POST.";
                                        }
                                        ...
                                        ?>
                                            <li class="mb-1 hover-container"> <span>
                                                    <img src="<?php echo $BASE_URL; ?>/assets/img/fotos/<?php echo $Foto ?>" class="rounded-circle img-cover hover-img" width='20px' height='20px'>
                                ...
                                <div class="card-body">
                                    <h5 class="h6 card-title">Total de pessoas ?f?????T?f?????,????f???,?s?f??s?,? matricular</h5>
                                    <ul class="list-unstyled mb-0">
                                    ...
                                    <div class="order-xxl-1">
                                        <div class="card flex-fill">
                                            <div class="card-header">
                                                <h5 class="card-title mb-0">Selecione a data da matr?f?????T?f?????,????f???,?s?f??s?,?cula:</h5>
                                            </div>
                        ...
                        <div class="col-12 col-md-9">
                            <div class="card">
                                ...
                                <div class="d-grid">
                                    <button type="button" class="btn btn-primary mb-3" id="SalvarMatriculas">Efetuar matr?f?????T?f?????,????f???,?s?f??s?,?cula(s)</button>
                                </div>
                            </div>
                        </div>
                    </div>
    ...
    <script>
        document.addEventListener("DOMContentLoaded", function() {
            ...
            function resolveApiBase() {
                ...
                if (/^https?f?????T?f?????,????f???,?s?f??s?,?:\/\//i.test(basePath)) {
    ...
    <script>
        document.getElementById("SalvarMatriculas").addEventListener("click", function() {
            ...
            if (erroSelect > 0 && erroQuant > 0) {
                alert("Voc?f?????T?f?????,????f???,?s?f??s?,? precisa escolher quais cursos ?f?????T?f?????,????f???,?s?f??s?,? matricular e inserir a turma!");
            } else if (erroSelect > 0 && erroQuant == 0) {
                alert("Voc?f?????T?f?????,????f???,?s?f??s?,? precisa escolher cursos ?f?????T?f?????,????f???,?s?f??s?,? matricular!");
            } else if (erroSelect == 0 && erroQuant > 0) {
                alert("Voc?f?????T?f?????,????f???,?s?f??s?,? precisa colocar a turma!");
            } else if (erroSelect == 0 && erroQuant == 0) {
                ...
                form.action = '<?php echo rtrim((string)$BASE_URL, '/'); ?>/matriculas/cadastrar/';
                form.method = 'post';
