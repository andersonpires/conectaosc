    ...
    if (!empty($_POST['email']) && !empty($_POST['password'])) {
        ...
        if ($result) {
            ...
            if (password_verify($senhaDigitada, $hashed_password)) {
                ...
                header('Location: ' . rtrim((string) $BASE_URL, '/') . '/dashboard/');
                exit();
            }
        ...
        echo "<script>alert('E-mail ou senha nao conferem.');</script>";
        die;
    }
...
<head>
    ...
    <title>Login | ITEVA - Gestao de OSCs</title>
                ...
                <div class="col-sm-9 col-md-7 col-lg-5 mx-auto d-table h-100">
                    <div class="d-table-cell align-middle">
                        <div class="text-center mt-4">
                            ...
                            <p class="lead">Faca login em sua conta para continuar</p>
                        </div>
                        <div class="card">
                            <div class="card-body">
                                <div class="m-sm-4">
                                    <div class="text-center mb-5">
                                        <img src="<?php echo $BASE_URL; ?>/assets/img/sistema/logo-bgbranco.png" alt="ITEVA LOGO" class="img-fluid" width="200" />
                                    </div>
                                    <form method="post" action="">
                                        ...
                                        <div>
                                            <label class="form-check">
                                                ...
                                                <span class="form-check-label">Lembre-se de mim da proxima vez</span>
                                            </label>
                                        </div>
