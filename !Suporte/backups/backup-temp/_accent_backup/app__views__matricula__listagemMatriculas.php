...
// Verifica se as variaveis de sessao BASE_PATH e BASE_URL estao definidas
        ...
        <div class="main">
            ...
            <main class="content">
                <div class="container-fluid p-0">
                    ...
                    <div class="col-12">
                        <h4 class="h3 mb-3" id="titulo">Total de matriculas</h4>
                        <div class="card">
                            <div class="card-body">
                                <div class="d-flex flex-wrap justify-content-between align-items-center gap-2 mb-3">
                                    <a href="<?php echo $BASE_URL; ?>/beneficiarios/lista?matricula=1" class="btn btn-primary" id="novoAluno">Matricular novo aluno</a>
                                    <div class="d-flex align-items-center gap-2">
                                        <label class="form-label mb-0">Filtro de situacao</label>
                                        <div class="btn-group" role="group" aria-label="Filtro de situacao">
                                            <button type="button" class="btn filtro-situacao-turma filtro-ativo" data-value="Ativo">
                                                Ativo
                                            </button>
                                            <button type="button" class="btn filtro-situacao-turma filtro-concluido" data-value="Concluido">Concluido</button>
                                ...
                                <div class="table-responsive">
                                    <table id="minhaTabela" class="table table-striped table-hover">
                                        <thead>
                                            <tr>
                                                <th scope="col">N?f???,?s?f??s?,?</th>
                                                <th scope="col">Curso</th>
                                                <th scope="col">Turma</th>
                                                <th scope="col">Local</th>
                                                <th scope="col">Qtd alunos</th>
                                                <th scope="col" style="width: 7%;">Situacao</th>
                                        ...
                                        <tbody>
                                            ...
                                            ?>
                                                <tr>
                                                    ...
                                                    <td><?php echo "<a href='" . $BASE_URL . "/matriculas/turma?turma=$IdTurma'>$nomeTurma</a>" ?></td>
                                                    <td><?php echo $Local ?></td>
                                                    <td><?php echo $QtdAlunos ?></td>
                                                    <td style="width: 7%;"><?php echo ($Habilitado ? "<span class='badge bg-warning'>Em progresso</span>" : "<span class='badge bg-success'>Concluido</span>") ?></td>
                                                    <td>
                                                        <a class="btn btn-info btn-sm" href="<?php echo rtrim((string)$BASE_URL, '/'); ?>/matriculas/contratos/curso/?curso=<?php echo $dados['IdCurso']; ?>" title="Gerar contratos do curso" target="_blank">
...
<script>
    document.addEventListener("DOMContentLoaded", function() {
        ...
        if (tituloElement) {
            tituloElement.textContent = "Total de matriculas: <?php echo $rowCount ?>";
        }
        setTimeout(() => {
